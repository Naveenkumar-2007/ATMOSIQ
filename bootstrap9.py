# bootstrap9.py -> run: python bootstrap9.py
import os
...
# Archive (ERA5) — these variable names work on archive-api.
...
# Archive daily uses 2m-suffixed names (different from forecast API!).
DAILY_HISTORICAL_VARIABLES: list = [
    "temperature_2m_max", "temperature_2m_min", "precipitation_sum",
    "wind_speed_10m_max", "wind_gusts_10m_max",
]

# Forecast endpoint uses the full variable set.
...
# Tighten the historical window to 2 full years (archive handles this cleanly).
...
print(f"Part 9 written: {len(W)} files.")
